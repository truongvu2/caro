    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Click(object sender, EventArgs e)
        {
            ...
            if (vtMap[x, y] != 0)
                return;
            // Phát âm thanh
            SoundPlayer soundPlayer = new SoundPlayer(@"D:\Game Co Caro\Game Co Caro\amthanh\amthanh.wav");
            soundPlayer.Play();
        ...
        private void howPlayGameToolStripMenuItem_Click(object sender, EventArgs e)
        {           
        ...
        private void gameDevelopmentHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void displayToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                // Lấy màu mà người dùng đã chọn
                Color selectedColor = colorDialog.Color;

                // Áp dụng màu mới cho bàn cờ
        ...
        {
            // Duyệt qua từng ô trên bàn cờ và thay đổi màu sắc
            for (int i = 2; i <= rows; i++)
            {
                for (int j = 1; j <= columns; j++)
                {
                    Map[i, j].BackColor = color;
                }
            }
        }
